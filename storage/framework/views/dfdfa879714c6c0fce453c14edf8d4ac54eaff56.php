        ...
        <?php $__env->startSection('content'); ?>
            ...
            <form method="POST" action="<?php echo e(route('company.update',$company->id)); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="companyTitle" id="companyTitle" class="form-control" value="<?php echo e($company->CompanyTitle); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="companyEmail" id="companyEmail" class="form-control" value="<?php echo e($company->Email); ?>">
                    <?php if($errors->has('companyEmail')): ?>
                        <span style="color: red"><?php echo e($errors->first('companyEmail')); ?></span>
                    <?php endif; ?>
                </div>
                <div class="form-group">
                    <div><img height="100px" src="<?php if(\Illuminate\Support\Str::contains($company->CompanyLogo,"images")): ?> <?php echo e(asset('storage/'.$company->CompanyLogo)); ?> <?php else: ?> <?php echo e($company->CompanyLogo); ?> <?php endif; ?>"></div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="companyWebsite" id="companyWebsite" class="form-control" value="<?php echo e($company->CompanyWebsite); ?>">
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\Mini-CRM\resources\views/company/edit.blade.php ENDPATH**/ ?>